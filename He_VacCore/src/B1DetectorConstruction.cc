...
// helium->GetIonisation()->SetMeanExcitationEnergy(41.8 * eV);
  ...
  // PVTVacuum vessel parameters
  G4double pVacVesselRmin = 499.0*cm; // 4.994*m
  ...
  G4double pVacVesselUpStreamEndcapRmin = 0.5*m;
  G4double pVacVesselUpStreamEndcapRmax = pVacVesselRmin;
  G4double pVacVesselUpStreamEndcapDz = 0.5*cm;



  
   // ***Vacuum vessel parameters vacuum vessel core
  G4double VacVesselRmin = 49.0*cm; // 4.994*m
  G4double VacVesselRmax = 50.0*cm;
  G4double VacVesselDz    = 5.00*m;  // half-length
  G4double VacVesselSphi  = 0; // radian
  G4double VacVesselDphi  = 2.0*M_PI;

  G4double VacVesselUpStreamEndcapRmin = 0.;
  G4double VacVesselUpStreamEndcapRmax = VacVesselRmin;
  G4double VacVesselUpStreamEndcapDz = 0.5*cm; //half-length


  G4Material* pvacuumVessel_mat = nist->FindOrBuildMaterial("G4_PLASTIC_SC_VINYLTOLUENE");
  ...
  //
  // plasticVacuum Vessel
  //

  G4Tubs* solidpVacuumVessel = new G4Tubs(
      "pvessel",
      pVacVesselRmin,
      pVacVesselRmax,
  ...
  G4LogicalVolume* logicalpVacuumVessel =
    new G4LogicalVolume(solidpVacuumVessel,
        pvacuumVessel_mat,
        "pvessel");

  new G4PVPlacement(0,
      G4ThreeVector(0, 0, 0),
      logicalpVacuumVessel,
      "physpVessel",
      logicWorld,
      false,
      0,
  ...
  G4Tubs* solidpVacuumVessel_UpstreamEndcap = new G4Tubs(
      "pvesselUpstreamEndcap",
      pVacVesselUpStreamEndcapRmin,
      pVacVesselUpStreamEndcapRmax,
      pVacVesselUpStreamEndcapDz,
      0.,
      2.0*M_PI);
  G4LogicalVolume* logicalpVacuumVesselUpstreamEndcap =
    new G4LogicalVolume(solidpVacuumVessel_UpstreamEndcap,
        pvacuumVessel_mat,
        "pvesselUpstreamEndcap");
  new G4PVPlacement(0,
      G4ThreeVector(0, 0, -499.5*cm),
      logicalpVacuumVesselUpstreamEndcap,
      "physpVesselUpstreamEndcap",
      logicWorld,
      false,
      0,
      checkOverlaps);

  G4Tubs* solidpVacuumVessel_DownstreamEndcap = new G4Tubs(
      "pvesselDownstreamEndcap",
      pVacVesselUpStreamEndcapRmin,
      pVacVesselUpStreamEndcapRmax,
      pVacVesselUpStreamEndcapDz,
      0.,
      2.0*M_PI);
  G4LogicalVolume* logicalpVacuumVesselDownstreamEndcap =
    new G4LogicalVolume(solidpVacuumVessel_DownstreamEndcap,
        pvacuumVessel_mat,
        "pvesselDownstreamEndcap");
  new G4PVPlacement(0,
      G4ThreeVector(0, 0, 499.5*cm),
      logicalpVacuumVesselDownstreamEndcap,
  ...
  fSensorPV = new G4PVPlacement(0,
              G4ThreeVector(0, 0, 500.5*cm + pVacVesselUpStreamEndcapDz),
...
//  now the vacvessel
  ...
  G4Tubs* solidVacuumVessel_UpstreamEndcap = new G4Tubs(
      ...
      VacVesselUpStreamEndcapRmin,
      VacVesselUpStreamEndcapRmax,
      VacVesselUpStreamEndcapDz,
      0.,
      2.0*M_PI);
