...
nistManager->FindOrBuildMaterial("G4_Plastic_SC_VINYL TOLUENE");
G4Material* pvt = G4Material::GetMaterial("G4_Plastic_SC_VINYL TOLUENE");
...
// helium->GetIonisation()->SetMeanExcitationEnergy(41.8 * eV);
  ...
  G4double pVacVesselUpStreamEndcapDz = 1.0*cm;
